...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        const { user } = this.state;
        if (user.firstName && user.lastName && user.password && user.email && user.fatherName && user.dob && user.mobile && user.country && user.gender) {
           console.log(user);
        ...
        return (
            <div className="col-md-12">
                ...
                <div className="col-md-6"> 
                    ...
                    <label className="radio-inline">
                    <input type="radio" name="gender" value="0" onChange={this.handleChange} />Female
                    </label>   
